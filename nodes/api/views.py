...
from nodes.pagination import NodePagination
from nodes.serializers import ConnectNodesSerializer
from nodes.serializers import CreateNodeSerializer
from nodes.serializers import FindPathSerializer
from nodes.serializers import NodeSerializer
from nodes.serializers import TaskResultSerializer
from nodes.tasks import simple_find_path_task
from nodes.utils import find_path_by_names
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            task = simple_find_path_task.apply_async(
                args=[from_node_name, to_node_name],
                countdown=5,
            )
